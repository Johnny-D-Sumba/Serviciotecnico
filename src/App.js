...
const App = () => {
    ...
    const menu = [
        ...
        {
            label: 'Empresa', icon: 'pi pi-fw pi-clone',
            items: [
                { label: 'Actualizar', icon: 'pi pi-fw pi-user-edit', to: '/crud-empresa' },
            ]
        },
        {
            label: 'Facturación', icon: 'pi pi-fw pi-search',
            items: [
                {
                    label: 'Factura', icon: 'pi pi-fw pi-bookmark',
                    items: [
                        { label: 'Generar factura', icon: 'pi pi-fw pi-user-edit', to: '/crud-factura' },
                        { label: 'Lista de facturas', icon: 'pi pi-fw pi-user-edit', to: '/lista-factura' },
                    ]
                },
            ]
        },
